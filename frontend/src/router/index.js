...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'security-rules/:tenantId', name: 'SecurityRules', component: () => import('@/views/SecurityRules.vue') },
      { path: 'traffic/:tenantId', name: 'Traffic', component: () => import('@/views/Traffic.vue') },
      { path: 'boot-volumes/:tenantId', name: 'BootVolumes', component: () => import('@/views/BootVolumes.vue') },
      { path: 'vcn/:tenantId', name: 'VcnManage', component: () => import('@/views/VcnManage.vue') },
      { path: 'limits/:tenantId', name: 'Limits', component: () => import('@/views/Limits.vue') },
      ...
      { path: 'ip-data', name: 'IpData', component: () => import('@/views/IpData.vue') },
